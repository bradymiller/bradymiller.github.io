...
### STAT
1. Release patch 1 (md5sum:f026ff19ac682dae4c5ff85c1dda9f5b) (branch test passed,and patch PENDING testing) and new docker/zip(md5sum: aee25be40d8a4cfdf866ef8d3dac676c)/tar(md5sum: a238f73ce95307a3fda854a0f34352d2)(PENDING testing) packages (when done, then change docker examples back to mariadb)
