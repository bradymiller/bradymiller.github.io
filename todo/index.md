...
### Under Consideration
1. use better random password generation for portal (increase to 12 and random gen until ensure all char types are in it; place the function in RandomGenUtils called soemthing like portalGeneratePassword() )
