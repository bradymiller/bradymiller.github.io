...
1. Finalized whether to use Strict or Lax for the cookie_samesite setting when creating session in php 7.3. Leaning towards Strict, but need to do a bit more research.
