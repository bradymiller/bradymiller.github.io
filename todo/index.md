...
1. remove headers with sensitive information of oeHttp when used to collect/send outbound information (DONE and in codebase, just test with error_log() call to ensure working as it should)
