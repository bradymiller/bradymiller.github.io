...
### STAT
1. Prep for 5.0.2 release (next ups are: eye form updates; instance uuid mechanism (in globals that autopopulates when is empty and save globals); get docker to par and test ubuntu packaged)
