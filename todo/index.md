...
1. Will not add npm, node and/or nodejs on 5.0.2 dockers (also removed from flex dockers); this is because composer will offer the npm/node service. (for production packages, will remove node_modules from main directory after build)
